...
export const Testimonials = () => {
  ...
  const testimonials = [
    {
      name: 'Sophia Lee',
      review: t('The best cosmetic products I have ever used. My skin feels so refreshed and radiant!'),
      image: profile,
    },
    {
      name: 'Emma Watson',
      review: t('Absolutely love the quality and results. Highly recommend to everyone!'),
      image: profile,
    },
    {
      name: 'Olivia Martinez',
      review: t('Fantastic products with great pricing. My go-to cosmetic brand!'),
      image: profile,
    },
  ];
  ...
  return (
    <section className="p-6 bg-gradient-to-r from-pink-100 to-purple-200">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 text-green-500">What Our Customers Say</h2>
